...
public sealed class DynamicPartOrderByInputGraphType : OrderByInputObjectGraphType
{
    private ContentTypePartDefinition _part;

    public DynamicPartOrderByInputGraphType(ContentTypePartDefinition part)
    {
        Name = $"{part.Name}OrderByInput";
        _part = part;
    }
